...
class InternetSpeedTwitterBot:
    ...
    def tweet_at_provider(self):
        ...
        tweet = f"Привет Интернет Провайдер,почему мой скорость интернета {self.up} загрузки/ {self.down} отгрузки когда я плачу для {PROMISED_DOWN} загрузки/{PROMISED_UP} отгрузки?"
